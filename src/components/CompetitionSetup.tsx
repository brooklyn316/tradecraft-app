  ...
  return (
    <div className="p-6 space-y-7 max-w-lg mx-auto">
      ...
      <div>
        ...
        {/* Bot cards — shown when vs AI selected */}
        {mode === "bot" && (
      ...
      <div>
        ...
        {mode === "bot" && (
          <p className="text-[10px] text-[rgba(232,234,240,0.38)] mt-2">
            {duration === "week"  && "One week. Fast and brutal — the bots have less time to compound but so do you."}
            {duration === "month" && "Recommended. Enough time for strategy to play out and the leaderboard to shift."}
            {duration === "year"  && "A full year. The bots will compound hard. You'll need to stay sharp the whole time."}
          </p>
        )}
      </div>
